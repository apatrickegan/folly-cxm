...
static const char *APP_CSS =
    ...
    ".title { font-size: 11pt; font-weight: bold; color: #6366f1; }"
    ".clock { font-size: 8pt; color: #4b5563; }"
    ".count { font-size: 8pt; color: #475569; }"
    ".card-frame { background-color: #1a1d2e; border-radius: 5px;"
    "  border: 1px solid #252840; }"
    ".card-name  { font-size: 9.5pt; font-weight: bold; color: #f1f5f9; }"
    ".card-type  { font-size: 7pt;   font-weight: bold; }"
    ".card-agent { font-size: 7.5pt; color: #4b5563; }"
    ".card-added { font-size: 8pt;   color: #374151; }"
    ".card-step  { font-size: 7.5pt; color: #94a3b8; font-style: italic; }"
    ...
    ".task-title    { font-size: 9pt; font-weight: bold; color: #e2e8f0; }"
    ".task-lead     { font-size: 7.5pt; color: #6366f1; }"
    ".task-agent    { font-size: 7.5pt; color: #4b5563; }"
    ".task-due      { font-size: 7.5pt; color: #f97316; }"
    ".task-due-ok   { font-size: 7.5pt; color: #374151; }"
    ".task-done     { font-size: 7.5pt; color: #374151; }"
    ".status-pending    { color: #f97316; font-size: 7pt; font-weight: bold; }"
    ".status-inprogress { color: #6366f1; font-size: 7pt; font-weight: bold; }"
    ".status-done       { color: #374151; font-size: 7pt; }"
    /* Search */
